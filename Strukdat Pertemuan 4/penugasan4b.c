 ...
 *KELAS     : 2KS1
 *NO. ABSEN : 36
 STRUKTUR DATA MODUL 4 PENUGASAN BAGIAN 2
    ...
    • buat temporary pointer node sebagai bantuan: prev, current, next dan
...
ptrnode reverse(ptrnode head){
    ...
    head = prev;
    puts("Urutan daftar nilai sudah dibalik!");
    return head;   
}
...
int main(){
    ...
    while (1)
    {
        ...
        puts("**11. Tampilkan nilai secara reversed**");
        puts("\n12. KELUAR");                
